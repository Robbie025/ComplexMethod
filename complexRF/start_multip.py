...
def apply(func,xlow,xup,samplingmethod,option):  
    xmin,fmin,funcVector,allf,Iterations,conv,noofevaluations = cp.complexpy_(func,xlow,xup,samplingmethod,option) 
...
"""
from src.testfunctions.objfunc import install as obj
...
"""
import src.sampling as samplingmethod
samplingmethod = "LHS"
option=True
